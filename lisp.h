...
lisp* fill_lisp(char* str, int index);
void copy_str(char* cur_str, char str[], int index);
...
void test(void);
int fill_str(char* str, int atom);
int fill_list(char* str, lisp* l);
void init_str(char* str, lisp* l);
int cnt_num(int num);
